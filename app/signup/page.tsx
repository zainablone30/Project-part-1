          ...
          <div className="text-center text-white max-w-lg">
            ...
            >
              ...
              <p className="text-lg text-white/80">
                Discover AI-powered meals tailored to your mood, health conditions, and dietary needs
                from Pakistan&apos;s finest home chefs
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <Link href="/" className="flex items-center gap-2 mb-8">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-xs font-bold px-1.5 py-0.5 rounded bg-primary text-primary-foreground">
                AI
              </span>
            </div>
          </Link>
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-sm text-muted-foreground">
            <span className="flex items-center gap-1">
              <Check className="w-4 h-4 text-primary" /> Secure
            </span>
            <span className="flex items-center gap-1">
              <Check className="w-4 h-4 text-primary" /> Easy
            </span>
            <span className="flex items-center gap-1">
              <Check className="w-4 h-4 text-primary" /> Fast
            </span>
          </div>
        </div>
      </div>
